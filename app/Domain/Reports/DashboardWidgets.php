    ...
    private function admin(User $user): array
    {
        ...
        return [
            'stats' => [
                ...
                ['label' => 'No-coords properties', 'value' => Property::whereNull('latitude')->where('geocode_status', '!=', Property::GEOCODE_NOT_REQUESTED)->count(), 'icon' => 'building', 'url' => route('properties')],
            ],
            'attention' => [
